...
process is conducted in an efficient manner. (© Denotes “common” options or settings)
     ...
     TSD page
      ...
      THRT SHOW Options
      COORD SHOW Options (NAV/ATK)
      © TIME Format
      © SYSTEM TIME>
      © RTE Options                                                                 COM page
      MAP Options                                                                      ©   VHF PRI/STBY frequency/network
      © INST Options (if necessary)                                                    ©   UHF PRI/STBY frequency/network
                                                                                       ©   FM1 PRI/STBY frequency/network
     WPN page                                                                          ©   FM2 PRI/STBY frequency/network

       GRAYSCALE (IHADSS BRT/CON)
       BORESIGHT (IHADSS)                                                           UTIL page
       © CHAN Settings (Channels 1-4)                                                  © ANTI-ICE MODE (AUTO/MANUAL)
       © CODE Settings (LRFD/LST)                                                      © ANTI-ICE Settings (Manual mode)
       © LRFD Mode (FIRST/LAST)
       GUN Settings (BURST/MODE)
                                        FLT page           FUEL page          PERF page
       RKT Settings (INVENTORY/QTY)
       MSL Settings (TYPE/MODE/TRAJ)     © HI>              © CHECK MINUTES    ©   PERF Modes
       © MSL Channels (PRI/ALT)          © LO>                                 ©   PA> (MAX/PLAN)
       ACQ Setting                       © ALT> or PRES>                       ©   FAT> (MAX/PLAN)
       MANRNG>                           UNIT Options                          ©   GWT> (MAX/PLAN)
...
4.     PLT RTR BRK switch – OFF (or LOCK if
      performing a Rotor Lock start).                           7
...
5.   PLT / CPG   Systems – Check as follows:
    ...
    -   Fuel quantity – Check; verify sufficient fuel                       5             5
                                                                     1
