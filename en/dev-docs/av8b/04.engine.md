...
![402-RR-408 Engine Source: globalsecurity.org](img/img-127-717.jpg)
...
horizontal (fully aft) to nozzle braking position (at 98.5°).
    ...
    Braking Stop | 98.5°        |Used to slow down (both in the air and on the ground)
...
position.
    ...
    ![Nozzles set to 0° (fully aft)        ](img/img-130-740.jpg)
    
    ![Nozzles set to 10° for taxi](img/img-130-742.jpg)
    
    ![Nozzles set to 82° (hover stop)        ](img/img-130-744.jpg)
    
    ![Nozzle set to 98.5° (braking stop)](img/img-130-746.jpg)


### CMBT SWITCH AND LIGHT
...
### JPTL (JET PIPE TEMPERATURE LIMITER) SWITCH
...
#### Airstart Switch. The airstart button is located on the front of the
...
#### Ignition Isolation (IGN ISO) Switch. It is located on the
...
#### Engine Start Switch. The engine start switch is located on the

right console. Placing the switch to ENG ST initiates the GTS and
engine starting sequence

#### DECS Enable Switch. Located on the rear - left panel. DECS
...
#### Manual Fuel Switch. The MFS provides an alternate means of
...
#### Water Injection Switch. This 3-position switch
...
#### Water Dump Switch. Located on the left panel. This switch can

be used to dump water from the tank by selecting DUMP position.

#### Water Injection System Warning / Caution Lights
...
### GAS TURBINE STARTER / AUXILIARY POWER UNIT CAUTION LIGHT
