...
Joint Direct Attack Munition (JDAM) is a low-drag general-purpose bomb fixed with an attached
...
AGM-154 Joint Standoff Weapon (JSOW) is a glide weapon that allows much greater attack
...
AGM-154A BLU-97/B (combined effects BRU-32 (×1), BRU- 2, 3, 7, 8 Tail: FMU-152/B, FMU-
bomb) 55A/A (×2) 139A/B
AGM-154C BROACH (multi-stage BRU-32 (×1), BRU- 2, 3, 7, 8 Tail: FMU-152/B, FMU-
penetrating) 55A/A (×2) 139A/B
...
Figure 102. GPS Weapon SMS Format
...
Figure 103. GPS Weapon SMS Format
...
Figure 104. GPS Weapon SMS Format
...
Figure 105. GPS Weapon SMS Format
...
Mission Select Number
Options




Terminal Phase Options
...
Figure 106. GPS Weapon SMS Format
...
Figure 107. GPS Weapon TOO SMS Format
...
Minimum Range JDAM/JSOW Target
...
Predictive Max Range




Figure 108. GPS Weapon HSI Format
...
Mission Practice: Hornet A/G Gun




Mission Practice: Hornet Rockets
...
NOTE: In the Mission Editor, there is an Aircraft Properties tab in the Aircraft/Payload menu. This can
...
Mission Practice: AGM-65E Laser Maverick
...
Figure 113. AGM-65E Stores Page
...
20° Gimbal Angle Laser Operating Codes




Figure 114. AGM-65E Format Page
...
Figure 115. AGM-65E Format Page, Locked
...
Figure 117. AGM-65F Stores Page
...
Tracking Polarity Field of View




Figure 118. AGM-65 Format Page
...
Figure 120. OPTIONS/SPECIAL TDC Slew
...
Figure 121. AGM-65F Track Video
...
Figure 123. AGM-65 Video and HUD
AGM-88 HARM
...
HARM Override unboxed




Figure 128. HRM OVRD inactive, Pullback mode active
...
Figure 131. “PLBK” label displayed when Pullback is inhibited.
Notes
...
Figure 137. HARM Pre-Briefed Mode
...
Figure 138. HARM PB UFC options
...
Figure 139. HARM PB HUD symbology
...
Weapon Select Harpoon Turnpoint (HPTP)




Delivery Mode Fixed Point (FXP)
...
Figure 141. Harpoon UFC Options
...
Figure 142. Harpoon HSI page
Harpoon Turnpoint




Figure 143. Harpoon Turnpoint
...
Weapon Select Range Status



SLAM Warmup Timer SLAM Turnpoint (STP)
...
Figure 145. SLAM-ER STP List

Select the pushbutton next to “STP1” on the UFC to set STP 1.
Figure 146. SLAM-ER STP Creation
...
Field of View
Tracking Polarity Option
and Status


Field of View
Aiming Cross Indication




Figure 147. SLAM-ER Datalink Video
...
AGM-62 Walleye II ER/DL with AWW-13 Datalink
Pod
...
Figure 148. Walleye II ER/DL
Figure 149. AN/AWW--13
...
Figure 150. Datalink Only Format
...
Figure 151. Walleye Only Format
Weapons Practice: AGM-62 Walleye
...
Note: if you are not then receiving seeker video, you probably need to set the datalink to the other
channel (either channel 2 or 8).
Figure 152. Combined Walleye and Datalink Format
Walleye HUD
