...
[Markdown Moster](https://markdownmonster.west-wind.com/): крайне хорош, способен вставлять картинки из буфера и сохранять их в подкаталоге.
Платный, хотя, как будто бы работает и незарегистрированным.

![](img/help/mm.jpg)

[Typora](https://typora.io/#windows): бесплатен, умеет работать с картинками из буфера (для этого нужно указать относитльность путей в настройках).
