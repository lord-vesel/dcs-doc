...
CHAPTERS="2. Краткая историческая справка
3. Установка и настройка модуля
4. Основные сведения о DCS МиГ-21БИС.
5. Эксплуатационные ограничения
6. Приборное оборудование кабины
7. Взлет и посадка
8. Выполнение маневров и фигур высшего пилотажа
9. Навигация
10. Система управления оружием СУО
11. Действия в особых случаях
"
